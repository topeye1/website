    ...
    <div id="friend-card-pc">
        <div class="friend-card-header justify-content-center notice-card-header mt-3 position-relative" style="display: flex;">
            <ul class="nav nav-underline mt-3" style="font-size: 16px">
                <li class="nav-item">
                    <a class="nav-link active" id="link-friend-friend" data-set="friend" href="#">{{ __('userpage.friend') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="link-friend-settlement" data-set="settlement" href="#">{{ __('userpage.settlement') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="link-friend-points" data-set="points" href="#">{{ __('userpage.points') }}</a>
                </li>
            </ul>
            <div class="d-flex align-items-center mt-3 pl-3 pt-1 pb-1 pr-3 top-my-info">
                <div class="align-items-center" id="top-my-profit" style="display: flex;">
                    <img src="{{URL::asset('assets/img/pngs/coin.png')}}" class="mr-1" style="width: 1.2rem; height: 1.2rem">
                    <span class="d-flex mr-3" style="font-size: 0.75rem">{{ __('userpage.my_revenue') }}</span>
                ...
                <div class="align-items-center" id="top-my-points" style="display: none;">
                    <img src="{{URL::asset('assets/img/pngs/point.png')}}" class="mr-1" style="width: 1.2rem; height: 1.2rem">
                    <span class="d-flex mr-3" style="font-size: 0.75rem">{{ __('userpage.hold_points') }}</span>
