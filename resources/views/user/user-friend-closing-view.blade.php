<div class="col-12">
    <div class="table-responsive">
        <table class="table table-bordered user-page-table">
            <thead>
            <tr>
                <th>{{ __('userpage.period') }}</th>
                <th>{{ __('userpage.my_revenue') }}</th>
                <th>{{ __('userpage.deduction') }}</th>
                <th>{{ __('userpage.agent_friends_revenue') }}</th>
                <th>{{ __('userpage.final_amount') }}</th>
                <th>{{ __('userpage.completed') }}</th>
            </tr>
            </thead>
...
@include('layouts.page-closing-nav')
