                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-3">{{ __('userpage.signup1') }}</h1>
                        </div>
                        <form class="user">
                            ...
                            <div class="form-group row mb-1 mt-1">
                                ...
                                <div class="col-md-5 middle-btn">
                                    <div id="button_send_code" class="btn btn-primary btn-user btn-block">{{ __('userpage.send_code') }}</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3 mt-1">
                                ...
                                <div class="col-md-5 middle-btn">
                                    <div id="button_auth" class="btn btn-primary btn-user btn-block">{{ __('userpage.auth') }}</div>
                                </div>
                            ...
                            <div class="form-group mb-1 mt-1">
                                <input type="password" class="form-control form-control-user my-input" name="input_password" id="input_password" placeholder="{{ __('userpage.password') }}">
                            </div>
                            <div class="form-group my-form mb-3">
                            ...
                            <div class="form-group my-form mb-0">
                                {{ __('userpage.confirm_pwd') }}
                            </div>
                            <div class="form-group mb-1 mt-1">
                                <input type="password" class="form-control form-control-user my-input" name="input_check_password" id="input_check_password" placeholder="{{ __('userpage.confirm_pwd') }}">
                            </div>
                            <div class="form-group my-form mb-3" id="confirm_pwd">
                                <span class="form-label" id="nomatch_pwd" style="color: red; display: none;">{{ __('userpage.nomatch_pwd') }}</span>
                            </div>
                            ...
                            <div id="button_login" class="btn btn-primary btn-user my-view btn-block mb-2">{{ __('userpage.conditions_view') }}</div>

                            <div class="form-group my-form mb-3 row">
                                <div class="col-md-9 pl-3 d-flex justify-content-center align-items-end">
                                    <span class="form-label" style="text-align: right">{{ __('userpage.agree_conditions') }}</span>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div id="button_login" class="btn btn-primary btn-user btn-block">{{ __('userpage.sign_up') }}</div>
