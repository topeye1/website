<div id="setting_trade">
    ...
    <div class="row justify-content-center align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div class="col-4 d-flex justify-content-end">{{ __('userpage.max_trade_price') }}</div>
        ...
        <div>
            @include('tooltip.max_trade_price')
        </div>
    </div>
    <div class="row justify-content-center align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div class="col-4 d-flex justify-content-end">{{ __('userpage.trade_leverage') }}</div>
        <div class="col-6 select-direction">
        ...
        <div>
            @include('tooltip.trade_leverage')
        </div>
    </div>
    <div class="row justify-content-center align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div class="col-4 d-flex justify-content-end">{{ __('userpage.liquidation_per_trade') }}</div>
        <div class="col-6 select-direction">
        ...
        <div class="col-md-2 d-flex" style="align-items: center;">
            <img id="liquidation_per_trade_help" src="/assets/img/pngs/help.png" style="width: 20px; height: 20px; cursor: pointer;">
        </div>
        <div>
            @include('tooltip.liquidation_per_trade')
        </div>
    </div>
    <div class="row justify-content-center align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div class="col-4 d-flex justify-content-end">{{ __('userpage.profit_per_trade') }}</div>
        <div class="col-6 select-direction">
        ...
        <div>
            @include('tooltip.profit_per_trade')
        </div>
    </div>
    <div class="row justify-content-center align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div class="col-4 d-flex justify-content-end">{{ __('userpage.auto_check_time') }}</div>
        <div class="col-6 select-direction">
