        ...
        <div class="table-responsive">
            <table class="table table-bordered user-page-table" id="dataTable">
                ...
                <tr id="thead_list">
                    ...
                    <th>{{ __('userpage.cash_balance') }}</th>
                    <th>{{ __('userpage.revenue1') }}</th>
                    <th>{{ __('userpage.roi_rate') }}</th>
                    <th>{{ __('userpage.fees') }}</th>
                    <th>{{ __('userpage.profit1') }}</th>
                    <th>{{ __('userpage.coupon_balance') }}</th>
                </tr>
                </thead>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.msg === "ok") {
                        $('#thead_list').html('');
                        let thead_tag = "";
                        thead_tag += "<th>{{ __('userpage.date') }}</th>";
                        if (parseInt(radio_idx) === 1) {
                            thead_tag += "<th>{{ __('userpage.cash_balance') }}</th>";
                        }
                        thead_tag += "<th>{{ __('userpage.revenue1') }}</th>";
                        thead_tag += "<th>{{ __('userpage.roi_rate') }}</th>";
                        thead_tag += "<th>{{ __('userpage.fees') }}</th>";
                        thead_tag += "<th>{{ __('userpage.profit1') }}</th>";
                        thead_tag += "<th>{{ __('userpage.coupon_balance') }}</th>";
