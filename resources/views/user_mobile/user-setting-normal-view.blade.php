<div id="setting_trade">
    ...
    <div class="d-flex ml-3">{{ __('userpage.lang') }}</div>
    ...
    <div class="d-flex ml-3">{{ __('userpage.phone') }}</div>
    ...
    <div class="d-flex ml-3">{{ __('userpage.password') }}</div>
    <div class="row align-items-center mt-1" style="width: auto; margin: 0 auto;">
        <div class="col-10">
    ...
    <div class="d-flex ml-3">{{ __('userpage.recommender') }}</div>
