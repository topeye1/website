    ...
    <div class="modal-dialog add-user" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="changePasswordModalLabel" style="text-align: center;">{{ __('userpage.change_password') }}</h5>
            </div>
            <div class="modal-body pl-5 pr-5">
                <div class="row">
                    <div class="col-12">{{ __('userpage.current_password') }}</div>
                    <div class="col-12">
                ...
                <div class="row mb-3">
                    <div class="col-12" style="color: #F84747; font-size: 0.8rem;">
                        <div id="err_nomatch_pwd" style="display: none;">{{ __('userpage.nomatch_pwd') }}</div>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-12">{{ __('userpage.new_password') }}</div>
                    <div class="col-12">
                        <input type="password" class="form-control form-control-user my-input" name="new_password" id="new_password">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">{{ __('userpage.re_enter_password') }}</div>
                    <div class="col-12">
                ...
                <div class="row mb-3">
                    <div class="col-12" style="color: #F84747; font-size: 0.8rem;">
                        <div id="err_password" style="display: none;">{{ __('userpage.err_password') }}</div>
                    </div>
                </div>
            </div>
