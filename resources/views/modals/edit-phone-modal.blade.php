    ...
    <div class="modal-dialog add-user" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="changePhoneModalLabel" style="text-align: center;">{{ __('userpage.change_phone_number') }}</h5>
            </div>
            <div class="modal-body pl-5 pr-5">
                <div class="row mb-3">
                    <div class="col-12">{{ __('userpage.current_phone_number') }}</div>
                    <div class="col-12">
                        <input type="text" class="form-control form-control-user my-input" name="current_phone_number" id="current_phone_number">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-12">{{ __('userpage.new_phone_number') }}</div>
                    <div class="col-12">
                        <input type="text" class="form-control form-control-user my-input" name="new_phone_number" id="new_phone_number">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">{{ __('userpage.re_enter_phone_number') }}</div>
                    <div class="col-12">
                ...
                <div class="row mb-3">
                    <div class="col-12" style="color: #F84747; font-size: 0.8rem;">
                        <div id="err_change_phone3" style="display: none;">{{ __('userpage.err_phone_number3') }}</div>
                        <div id="err_change_phone2" style="display: none;">{{ __('userpage.err_phone_number2') }}</div>
                    </div>
                </div>
            </div>
