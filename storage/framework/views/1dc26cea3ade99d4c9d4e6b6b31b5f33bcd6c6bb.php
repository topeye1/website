<div id="setting_trade">
    ...
    <div class="row align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div><?php echo e(__('userpage.max_trade_price')); ?></div>
        ...
        <div>
            <?php echo $__env->make('tooltip.mobile_max_trade_price', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    <div class="row align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div><?php echo e(__('userpage.trade_leverage')); ?></div>
        <div class="col-10 select-direction">
        ...
        <div>
            <?php echo $__env->make('tooltip.mobile_trade_leverage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    <div class="row align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div><?php echo e(__('userpage.profit_per_trade')); ?></div>
        <div class="col-10 select-direction">
        ...
        <div>
            <?php echo $__env->make('tooltip.mobile_profit_per_trade', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    <div class="row align-items-center mt-1 mb-3" style="width: auto; margin: 0 auto;">
        <div><?php echo e(__('userpage.liquidation_per_trade')); ?></div>
        <div class="col-10 select-direction">
        ...
        <div>
            <?php echo $__env->make('tooltip.mobile_liquidation_per_trade', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user_mobile/user-setting-trade-view.blade.php ENDPATH**/ ?>