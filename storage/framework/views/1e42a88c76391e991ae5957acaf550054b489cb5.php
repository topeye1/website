<?php $__env->startSection('content'); ?>
    ...
    <div class="form-group" style="width: 70%; margin: 0 auto;">
        <?php echo $__env->make('user.user-revenue-chart-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="form-group" style="width: 70%; margin: 0 auto;">
        <?php echo $__env->make('user.user-revenue-list-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php echo $__env->make('layouts.master_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user/user-revenue-view.blade.php ENDPATH**/ ?>