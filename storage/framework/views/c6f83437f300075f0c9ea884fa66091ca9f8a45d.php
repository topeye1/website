<div id="setting_api_add" style="display:none;">
    ...
    <div class="row justify-content-center align-items-center mt-3" style="width: 70%; margin: 0 auto;">
        <div class="col-3"><?php echo e(__('userpage.api_key')); ?></div>
        <div class="col-9">
    ...
    <div class="row justify-content-center align-items-center mt-3" style="width: 70%; margin: 0 auto;">
        <div class="col-3"><?php echo e(__('userpage.secret_key')); ?></div>
        <div class="col-9">
            <div class="d-inline-block" style="width: 90%">
    ...
    <div class="row mt-5 mb-3" style="margin: 0">
        <div class="col-12 d-flex justify-content-center">
            <img src="<?php echo e(URL::asset('assets/img/pngs/ex_apiKey.png')); ?>" style="display:block;">
        </div>
...
<div id="setting_api_list" style="display:none;">
    ...
    <div class="col-12 mb-3 d-flex justify-content-end" style="margin-top: -2.5rem;">
        <div id="btn_key_add" class="btn btn-confirm" style="width: 150px;"><?php echo e(__('userpage.add_api')); ?></div>
    </div>
    <div class="col-12">
        <div class="table-responsive">
            <table class="table table-bordered user-page-table" id="keysTable">
                <thead>
                <tr>
                    <th><?php echo e(__('userpage.number')); ?></th>
                    <th><?php echo e(__('userpage.category')); ?></th>
                    <th><?php echo e(__('userpage.input_date')); ?></th>
                ...
                if (data.msg === "ok") {
                    ...
                    if (data.lists.length > 0) {
                        ...
                        for (let i = 0; i < lists.length; i++) {
                            ...
                            //tags += '<div id="btn-edit" class="btn btn-user my-middle-btn btn-block" onclick="onKeyEdit('+kid+',\''+api_key+'\',\''+secret_key+'\')">' + '<?php echo e(__('userpage.edit')); ?>' + '</div>';
                            //tags += '</td>';
                            tags += '<td class="text-nowrap align-middle">';
                            tags += '<div id="btn-delete_'+kid+'" class="btn btn-user my-middle-btn btn-block">' + '<?php echo e(__('userpage.delete')); ?>' + '</div>';
                            tags += '</td>';
                            tags += '</tr>';
                        }
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user/user-setting-api-view.blade.php ENDPATH**/ ?>