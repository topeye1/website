    ...
    <li class="nav-item dropdown no-arrow d-flex">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <div class="dropdown-header"><?php echo e(__('userpage.lang')); ?></div>
                <div id="selected_language">

                </div>
                <div class="dropdown-divider"></div>
                <div class="dropdown-header"><?php echo e(__('userpage.number_per_page')); ?></div>
...
<script>
    ...
    const lang_urls = [
        '<?php echo e(route('lang.switch', 'ko')); ?>',
        '<?php echo e(route('lang.switch', 'en')); ?>',
        '<?php echo e(route('lang.switch', 'zh-CN')); ?>',
        '<?php echo e(route('lang.switch', 'ja')); ?>'
    ];

    const show_counts = ["10", "20", "50"];
    const number_urls = [
        '<?php echo e(url('/' . $page='admin.pages10')); ?>',
        '<?php echo e(url('/' . $page='admin.pages20')); ?>',
        '<?php echo e(url('/' . $page='admin.pages50')); ?>'
    ];
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/layouts/top-view.blade.php ENDPATH**/ ?>