...
<script>
    function setFuncPageNavigation(total_pages, current_page, list_func) {
        let nav_tag = '';
        ...
        nav_tag+='<?php echo e(__('userpage.prev_page')); ?>';
        nav_tag+='</a>';
        nav_tag+='</li>';
        ...
        nav_tag+='<?php echo e(__('userpage.next_page')); ?>';
        nav_tag+='</a>';
        nav_tag+='</li>';
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/layouts/page-navigation-func.blade.php ENDPATH**/ ?>