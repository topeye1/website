    ...
    <div class="modal-dialog add-user" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title w-100" id="settingDiscountModalLabel" style="text-align: center;"><?php echo e(__('userpage.fee_setting')); ?></h6>
            </div>
            <div class="modal-body">
                ...
                <div class="row justify-content-center" id="total_friend_discount" style="display: flex">
                    <div style="width: 8rem;"><?php echo e(__('userpage.friends_discount')); ?></div>
                </div>
                <div class="row justify-content-center" id="every_friend_discount" style="display: none">
                    <span id="every_friend_name"></span>
                    <span><?php echo e(__('userpage.discount_rate')); ?></span>
                </div>
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/modals/setting-discount-modal.blade.php ENDPATH**/ ?>