                ...
                <div class="col-lg-6">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4"><?php echo e(__('userpage.admin_login')); ?></h1>
                        </div>
                        <form class="user">
                        <div class="form-group my-form mb-0">
                            ...
                            <div class="form-group mb-1 mt-1">
                                <input type="password" class="form-control form-control-user my-input" name="input_pass" id="input_pass" placeholder="<?php echo e(__('userpage.password')); ?>">
                            </div>
                        ...
                        if (data.msg === "ok") {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.msg === "ok") {
                                        window.location.href = "<?php echo e(url('/admin.dashboard-view/dashboard')); ?>";
                                    } else {
                                        alert(data.cont);
                                    }
                            ...
                            const message = "<?php echo e(__('userpage.error_id')); ?>";
                            alert(message);
                        } else if (data.msg === 'nonpwd') {
                            const message = "<?php echo e(__('userpage.error_pwd')); ?>";
                            alert(message);
                        }
...
<?php echo $__env->make('layouts.master_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/admin/login.blade.php ENDPATH**/ ?>