                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body my-top-card">
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <a href="<?php echo e(url('/admin.user-view/user-list')); ?>">
                                    <div class="text-xs dash-top-text font-weight-bold text-primary text-uppercase mb-1">
                                        <?php echo e(__('userpage.total_users')); ?></div>
            ...
            <div class="col-xl-2 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body my-top-card">
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <a href="<?php echo e(url('/admin.usage-status-view/usage')); ?>">
                                    <div class="text-xs dash-top-text font-weight-bold text-success text-uppercase mb-1">
                                    <?php echo e(__('userpage.actived_user')); ?></div>
            ...
            <div class="col-xl-2 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body my-top-card">
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <a href="<?php echo e(url('/admin.agent-view/agent')); ?>">
                                    <div class="text-xs dash-top-text font-weight-bold text-info text-uppercase mb-1">
                                    <?php echo e(__('userpage.agent_user')); ?></div>
            ...
            <div class="col-xl-2 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body my-top-card">
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <a href="<?php echo e(url('/admin.agent-calc-request/request')); ?>">
                                    <div class="text-xs dash-top-text font-weight-bold text-warning text-uppercase mb-1">
                                    <?php echo e(__('userpage.request_point')); ?></div>
                    ...
                    <div class="card-body my-top-card">
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <a href="<?php echo e(url('/admin.user-view/user-list')); ?>">
                                    <div class="text-xs dash-top-text font-weight-bold text-warning text-uppercase mb-1">
                                    <?php echo e(__('userpage.day_new_user')); ?></div>
...
<?php echo $__env->make('layouts.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/admin/dashboard-view.blade.php ENDPATH**/ ?>