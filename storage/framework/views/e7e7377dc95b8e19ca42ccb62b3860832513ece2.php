    ...
    <div id="settings-card-pc">
        <div class="settings-card-header justify-content-center notice-card-header mt-3" style="display: flex;">
            <ul class="nav nav-underline mt-3" style="font-size: 16px">
                <li class="nav-item">
                    <a class="nav-link active" id="link-settings-api" style="padding: 0.2rem 1rem !important;" data-set="api" href="#"><?php echo e(__('userpage.api')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="link-settings-trade" style="padding: 0.2rem 1rem !important;" data-set="trade" href="#"><?php echo e(__('userpage.trade')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="link-settings-coin" style="padding: 0.2rem 1rem !important;" data-set="coin" href="#"><?php echo e(__('userpage.coin')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="link-settings-normal" style="padding: 0.2rem 1rem !important;" data-set="normal" href="#"><?php echo e(__('userpage.normal')); ?></a>
                </li>
            </ul>
        </div>
        ...
        <div class="settings-card-body d-flex justify-content-center">
            <div class="mt-3" id="setting_api" style="display:block; width: 100%">
                <?php echo $__env->make('user_mobile.user-setting-api-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div class="mt-3" id="setting_trade" style="display:none; width: 90%">
                <?php echo $__env->make('user_mobile.user-setting-trade-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div class="mt-3" id="setting_coin" style="display:none; width: 100%; font-size: 0.85rem;">
                <?php echo $__env->make('user_mobile.user-setting-coin-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div class="mt-3" id="setting_normal" style="display:none; width: 100%">
                <?php echo $__env->make('user_mobile.user-setting-normal-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.msg === "ok") {
                        ...
                        $('#mobile_tab_image').attr('src', '<?php echo e(URL::asset('assets/img/pngs/setting.png')); ?>');
                        $('#mobile_tab_text').text('<?php echo e(__('userpage.setting')); ?>');
                        $('#mobile_val_img').css('display', 'none');
                        $('#mobile_val_text').text('<?php echo e(__('userpage.fee_rate')); ?>');
...
<?php echo $__env->make('layouts.mobile_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user_mobile/user-setting-view.blade.php ENDPATH**/ ?>