<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('modals.current-order-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.msg === "ok") {
                        ...
                        $('#mobile_tab_image').attr('src', '<?php echo e(URL::asset('assets/img/pngs/trade.png')); ?>');
                        $('#mobile_tab_text').text('<?php echo e(__('userpage.trade')); ?>');
        ...
        function showLiveTradingList(lists, symbols, leverages, running, limits, holdings) {
            ...
            for (let i = 0; i < lists.length; i++) {
                    ...
                    if (holding === 0) {
                        if (is_run === 1) {
                            ...
                            if (is_run === 2) {
                                ...
                                bg_color = 'background-color: #d7d708;';
                            } else if (is_run === 4) {
                                bg_color = 'background-color: #92d050;';
                            }
                            tags += '        <span class="trade-color-break" style="'+bg_color+'">BREAK</span>';
                        }
                    } else {
                ...
                tags += '            <span class="btn btn-user my-middle-btn btn-block" id="btn-live-status_'+symbol+'"><?php echo e(__('userpage.order_status')); ?></span>';
                tags += '        </div>';
                tags += '        <div style="text-align: right; width: 100%;">';
                tags += '            <div style="font-size:0.7rem"><?php echo e(__('userpage.day_revenue_rate')); ?></div>';
                ...
                for (let k = 0; k < live_data.length; k++) {
                    ...
                    let side1 = '<?php echo e(__('userpage.side1')); ?>';
                    let side2 = '<?php echo e(__('userpage.side2')); ?>';
                    let side1_color = '#ff0000'
                    let side2_color = '#0070c0'
                    if (list.side === 'sell') {
                        side1 = '<?php echo e(__('userpage.side2')); ?>';
                        side2 = '<?php echo e(__('userpage.side1')); ?>';
                        side1_color = '#0070c0'
                        side2_color = '#ff0000'
                    }
            ...
            if (tags === '') {
                tags += '<a id="nav-setting-tab" href="<?php echo e(url('/user.user-setting-view/user-page/setting')); ?>" style="width: 100%; text-align: center;">';
                tags += '    <span style="color:#4e73df;"><?php echo e(__('userpage.add_coins')); ?></span>';
                tags += '</a>';
            }
                ...
                success: function (data) {
                    if (data.msg === "ok") {
                        ...
                        for (let i = 0; i < live_data.length; i++) {
                            ...
                            let items = [];
                            let margin = Math.round(list.order_money * 100000) / 100000;
                            ...
                            if (list.side === 'sell') {
                                if (parseInt(list.order_position) === 1) {
                                    ...
                                    items = [];
                                    items.push('TP');
                                    items.push(Math.round(list.tp_price * 10000) / 10000);
                                    items.push(margin);
                                    items.push(color_buy);
                                    ...
                                    items = [];
                                    items.push('<?php echo e(__('userpage.side2')); ?>');
                                    items.push(Math.round(list.order_price * 10000) / 10000);
                                    items.push(margin);
                                ...
                                if (parseInt(list.order_position) === 1) {
                                    ...
                                    items = [];
                                    items.push('<?php echo e(__('userpage.side1')); ?>');
                                    items.push(Math.round(list.order_price * 10000) / 10000);
                                    items.push(margin);
                                    items.push(color_buy);
                                    if (parseFloat(current_price) > parseFloat(list.order_price)) {
...
<?php echo $__env->make('layouts.mobile_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user_mobile/user-trade-view.blade.php ENDPATH**/ ?>