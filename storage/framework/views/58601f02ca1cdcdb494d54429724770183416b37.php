<div id="setting_trade">
    ...
    <div class="d-flex ml-3"><?php echo e(__('userpage.lang')); ?></div>
    ...
    <div class="d-flex ml-3"><?php echo e(__('userpage.phone')); ?></div>
    <div class="row align-items-center mt-1" style="width: auto; margin: 0 auto;">
        <div class="col-10">
    ...
    <div class="row mb-3" style="font-size: 0.8rem; color: #404450;">
        <div class="col-12">
            <div id="change_phone_number" style="display: none;"><?php echo e(__('userpage.change_ok')); ?></div>
        </div>
    </div>
    <div class="d-flex ml-3"><?php echo e(__('userpage.password')); ?></div>
    <div class="row align-items-center mt-1" style="width: auto; margin: 0 auto;">
        <div class="col-10">
    ...
    <div class="d-flex ml-3"><?php echo e(__('userpage.recommender')); ?></div>
    <div class="row align-items-center" style="width: auto; margin: 0 auto;">
        <div class="col-7">
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user_mobile/user-setting-normal-view.blade.php ENDPATH**/ ?>