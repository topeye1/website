        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            ...
            <div class="card param-tab">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w1')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w2')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w3')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w4')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w5')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w6')); ?></div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w8')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w9')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_w10')); ?></div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m1')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m2')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m3')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m4')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m5')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m7')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m8')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m9')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m10')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m11')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m12')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m13')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m14')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m15')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m16')); ?></div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_m19')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_e1')); ?></div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_e2')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_e3')); ?></div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_e4')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pr-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9"><?php echo e(__('userpage.param_e5')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer text-center card-notice-add-btn">
                    <div id="edit_param_button" class="btn btn-success mt-1" style="width: 80px; margin-right: 30px;"><?php echo e(__('userpage.edit')); ?></div>
                </div>
...
<?php echo $__env->make('layouts.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/admin/parameter-view.blade.php ENDPATH**/ ?>