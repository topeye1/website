<div class="row header-mobile" style="background-color:#CCD1DE; height: 58px;">
    ...
    <div class="col-4 d-flex justify-content-end align-items-center" id="div-user-info" style="font-size: 0.85rem;">
        ...
        <div>
            <img src="<?php echo e(URL::asset('assets/img/pngs/alarm.png')); ?>" class="mr-3">
        </div>
    </div>
</div>
...
<div class="row align-items-center" style="height: 50px;">
    <div class="col-2 d-flex justify-content-center">
        <img id="mobile_menu" src="<?php echo e(URL::asset('assets/img/pngs/mobile_menu.png')); ?>">
    </div>
...
<?php echo $__env->make('modals.mobile-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<script>
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/layouts/user-mobile-top.blade.php ENDPATH**/ ?>