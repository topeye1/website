    ...
    <div class="modal-dialog add-user" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="addModalLabel" style="text-align: center;"><?php echo e(__('userpage.add_user')); ?></h5>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-md-6 pr-3">
                                <div class="row align-items-center">
                                    <div class="col-3"><?php echo e(__('userpage.id')); ?></div>
                                    <div class="col-9">
                                        <input type="email" class="form-control form-control-user my-input" name="input_id" id="input_id">
                                        <div class="error-text" id="error_id" style="display: none"><?php echo e(__('userpage.id_des')); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="row align-items-center">
                                    <div class="col-3"><?php echo e(__('userpage.phone')); ?></div>
                                    <div class="col-9">
                                        <input type="text" class="form-control form-control-user my-input" name="input_phone" id="input_phone">
                                        <div class="error-text" id="error_phone" style="display: none"><?php echo e(__('userpage.error_phone')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row w-100 mb-3 pl-3 pr-3 justify-content-start">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-xl-6 col-md-6 pr-3">
                                <div class="row align-items-center">
                                    <div class="col-3"><?php echo e(__('userpage.name')); ?></div>
                                    <div class="col-9">
                                        <input type="text" class="form-control form-control-user my-input" name="input_name" id="input_name">
                                        <div class="error-text" id="error_name" style="display: none"><?php echo e(__('userpage.error_name')); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="row align-items-center">
                                    <div class="col-3"><?php echo e(__('userpage.level')); ?></div>
                                    <div class="col-9">
                                        <input type="number" class="form-control form-control-user my-input" name="input_level" id="input_level" max="8" min="0" value="1">
                                        <div class="error-text" id="error_level" style="display: none"><?php echo e(__('userpage.error_level')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row w-100 mb-3 pl-3 pr-3 justify-content-start">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-xl-6 col-md-6 pr-3">
                                <div class="row align-items-center">
                                    <div class="col-3"><?php echo e(__('userpage.password')); ?></div>
                                    <div class="col-9">
                                        <div class="d-inline-block" style="width: 90%">
                                            ...
                                            <div class="error-text" id="error_pwd" style="display: none"><?php echo e(__('userpage.error_pwd')); ?></div>
                                        </div>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="row align-items-center">
                                    <div class="col-3"><?php echo e(__('userpage.confirm_pwd')); ?></div>
                                    <div class="col-9">
                                        <div class="d-inline-block" style="width: 90%">
                                            <input type="password" class="form-control form-control-user my-input" name="input_confirm_pwd" id="input_confirm_pwd">
                                            <div class="error-text" id="error_conf_pwd" style="display: none"><?php echo e(__('userpage.dont_match_pwd')); ?></div>
                                        </div>
                ...
                <div class="row w-100 mb-3 pl-3 pr-3 justify-content-start">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-xl-6 col-md-6 pr-3">
                                <div class="row align-items-center">
                                    <div class="col-3"><?php echo e(__('userpage.fee_rate')); ?></div>
                                    <div class="col-9">
                                        <input type="number" class="form-control form-control-user my-input" name="input_fee" id="input_fee" max="100" min="0">
                                        <div class="error-text" id="error_fee" style="display: none"><?php echo e(__('userpage.error_fee')); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-inline-block ml-3"><?php echo e(__('userpage.actived')); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal" id="btn_user_modal_cancel"><?php echo e(__('userpage.cancel')); ?></button>
                <a class="btn btn-primary" href="#" id="btn_modal_add" style="display: block;"><?php echo e(__('userpage.add')); ?></a>
                <a class="btn btn-primary" href="#" id="btn_modal_edit" style="display: none;"><?php echo e(__('userpage.edit')); ?></a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function setEditUserInfo(num, id, phone, name, level, fee, checked) {
        $('#addModalLabel').text('<?php echo e(__('userpage.edit_user')); ?>');
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/modals/add-user-modal.blade.php ENDPATH**/ ?>