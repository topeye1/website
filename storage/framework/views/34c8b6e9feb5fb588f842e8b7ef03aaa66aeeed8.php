<div class="row justify-content-center pay-body-content" style="margin: 0 auto; width: 90%;">
    <div class="tab-content d-flex pt-4 pb-4 justify-content-center" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-usdt" role="tabpanel">
            <div class="mb-3" style="width: 100%; margin: 0 auto;">
                <div class="row mb-2">
                    <div class="col-6" style="text-align: end;"><?php echo e(__('userpage.available_cash')); ?></div>
                ...
                <div class="row mb-2">
                    <div class="col-6" style="text-align: end;"><?php echo e(__('userpage.leverage_cash')); ?></div>
                    <div class="col-6 text-value-font">
                        <span>$</span>
                ...
                <div class="row mb-2">
                    <div class="col-6" style="text-align: end;"><?php echo e(__('userpage.max_trade_price')); ?></div>
                    <div class="col-6 text-value-font">
                        <span>$</span>
                ...
                <div class="row mb-2">
                    <div class="col-6" style="text-align: end;"><?php echo e(__('userpage.operable_coins')); ?></div>
                    <div class="col-6 text-value-font">
            ...
            <div class="mb-1">
                <div class="row">
                    <div class="col-12 mb-1 d-flex justify-content-center"><?php echo e(__('userpage.minimum_cash_desc1')); ?></div>
                </div>
                <div class="row">
                    <div class="col-12 mb-1 d-flex justify-content-center"><?php echo e(__('userpage.minimum_cash_desc2')); ?></div>
                </div>
            </div>
        </div>
    </div>
            ...
            success: function (data) {
                ...
                if (data.msg === "ok") {
                    ...
                    for (let i = 0; i < lists.length; i++) {
                        ...
                        tag += '<?php echo e(__('userpage.stop')); ?>';
                        tag += '</div>';
                        if (parseInt(list.status) === 1) {
                        ...
                        tag += '<?php echo e(__('userpage.start')); ?>';
                        tag += '</div>';
                        tag += '</div>';
                        tag += '</div>';
                        tag += '</div>';
                ...
                $('div[id^="btn-coin-start_"]').click(function(){
                    ...
                    let runable_coins = leverage / (limit_bet * 10);
                    if (runable_coins < live_coins + 1) {
                        alert("<?php echo e(__('userpage.error_cash1')); ?>\n<?php echo e(__('userpage.error_cash2')); ?>");
                    } else {
                        let oid=$(this).attr("id");
                        let coin_num = oid.split('_')[1];
                        let symbol = oid.split('_')[2];
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.msg === "ok") {
                    ...
                    alert("<?php echo e(__('userpage.api_description1')); ?> \n <?php echo e(__('userpage.api_description2')); ?>");
                } else if (data.msg === "err") {
                    alert("<?php echo e(__('userpage.api_description1')); ?> \n <?php echo e(__('userpage.api_description2')); ?>");
                } else if (data.msg === "cnt") {
                    let limit = data.limit;
                    alert("<?php echo e(__('userpage.live_coin_condition1')); ?>"+limit+"<?php echo e(__('userpage.live_coin_condition2')); ?>");
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user_mobile/user-setting-coin-view.blade.php ENDPATH**/ ?>