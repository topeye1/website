                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.msg !== "ok")
                                    {
                                        ...
                                        window.location.href = '<?php echo e(url('/user.user-revenue-view/user-page/revenue')); ?>';
                                    }
...
<?php echo $__env->make('layouts.master_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user/user_login.blade.php ENDPATH**/ ?>