    ...
    <div class="tab-content d-flex pt-4 pb-4 justify-content-center" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-usdt" role="tabpanel">
            <div class="mb-3" style="width: 100%; margin: 0 auto;">
                ...
                <div class="row mb-2">
                    <div class="col-6" style="text-align: end;"><?php echo e(__('userpage.leverage')); ?></div>
                    <div class="col-6 text-value-font">
                ...
                <div class="row mb-2">
                    <div class="col-6" style="text-align: end;"><?php echo e(__('userpage.req_coin_cash')); ?></div>
                    <div class="col-6 text-value-font">
                        <span>$</span>
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user/user-setting-coin-view.blade.php ENDPATH**/ ?>