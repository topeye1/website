...
<?php echo $__env->make('layouts.user-mobile-top', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <nav class="navbar-expand navbar-light" style="height: 100%">
                <div class="container container-lg" style="max-width: 100%; height: 100%">
                    ...
                    <div class="row justify-content-center" style="min-height: 30rem; background-color: white; height: 100%">
                        <div class="tab-content" id="nav-tabContent" style="background-color: #e3e6f0; width: 100%; height: 100%">
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/layouts/mobile_user.blade.php ENDPATH**/ ?>