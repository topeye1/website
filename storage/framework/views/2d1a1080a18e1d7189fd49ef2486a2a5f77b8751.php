    ...
    <div class="form-group" style="margin: auto;">
        ...
        <div class="row" style="margin: 0 auto; width: 100%;">
            <div class="col-12 mt-3">
                <h4 style="text-align: center; color: #404450; font-weight: bold">Live Coin</h4>
            </div>
        </div>
        <div class="row p-3" id="trading_live_list" style="margin: 0 auto; width: 100%; background-color: #DCE0ED">
        ...
        <div class="row" style="margin: 0 auto; width: 100%;">
            <div class="col-12 mt-3">
                <h4 style="text-align: center; color: #404450; font-weight: bold">Stop Coin</h4>
            </div>
        </div>
        <div class="row p-3" id="trading_stop_list" style="margin: 0 auto; width: 100%; background-color: #DCE0ED">
...
<?php echo $__env->make('layouts.master_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user/user-trade-view.blade.php ENDPATH**/ ?>