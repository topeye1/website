    ...
    <div class="col-12">
        <div class="line-chart-border">
            <div class="d-flex justify-content-center">
                <h6><?php echo e(__('userpage.total_asset')); ?></h6>
            </div>
...
<div class="row pl-2 pr-2 mb-3">
    <div class="col-12">
        <div class="line-chart-border">
            <div class="d-flex justify-content-center">
                <h6><?php echo e(__('userpage.live_coins')); ?></h6>
            </div>
...
<div class="row pl-2 pr-2 mb-3">
    <div class="col-12">
        <div class="line-chart-border">
            <div class="d-flex justify-content-center">
                <h6><?php echo e(__('userpage.roi_rate')); ?></h6>
            </div>
...
<div class="row pl-2 pr-2 mb-3">
    <div class="col-12">
        <div class="line-chart-border">
            <div class="d-flex justify-content-center">
                <h6><?php echo e(__('userpage.revenue1')); ?></h6>
            </div>
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user_mobile/user-revenue-chart-view.blade.php ENDPATH**/ ?>