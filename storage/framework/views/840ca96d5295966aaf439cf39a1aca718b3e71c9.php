<?php $__env->startSection('content'); ?>
                        ...
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <div class="font-weight-bold text-center mb-1">
                                    <?php echo e(__('userpage.today_revenue')); ?></div>
                ...
                <div class="card h-100 py-2" style="background-color: #F0F1F4;">
                    <div class="card-body my-top-card">
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <div class="font-weight-bold text-center mb-1">
                                    <?php echo e(__('userpage.cash_balance')); ?></div>
                        ...
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <div class="font-weight-bold text-center mb-1" id="revenue_text">
                                    <?php echo e(__('userpage.month_revenue')); ?>
                ...
                <div class="card h-100 py-2" style="background-color: #F0F1F4;">
                    <div class="card-body my-top-card">
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <div class="font-weight-bold text-center mb-1">
                                    <?php echo e(__('userpage.monthly_roi')); ?></div>
                ...
                <div class="card h-100 py-2" style="background-color: #F0F1F4;">
                    <div class="card-body my-top-card">
                        <div class="row no-gutters align-items-center dash-top-items">
                            <div class="col mr-2">
                                <div class="font-weight-bold text-center mb-1">
                                    <?php echo e(__('userpage.annual_roi')); ?></div>
    ...
    <div class="form-group" style="width: 95%; margin: 0 auto;">
        ...
        <div class="row mb-3">
            <?php echo $__env->make('layouts.page-navigation3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    <div class="form-group" style="width: 100%; margin: 0 auto;">
        <?php echo $__env->make('user_mobile.user-revenue-chart-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="form-group">
        <?php echo $__env->make('user_mobile.user-revenue-list-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
        ...
        function initDataPicker() {
            ...
            $('input[id^="seldate_"]').click(function(){
                ...
                //if (parseInt(radio_idx) === 1) {
                    $('#revenue_text').text('<?php echo e(__('userpage.month_revenue')); ?>');
                //} else {
                //    $('#revenue_text').text('<?php echo e(__('userpage.year_revenue')); ?>');
                //}
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.msg === "ok") {
                        ...
                        $('#mobile_tab_image').attr('src', '<?php echo e(URL::asset('assets/img/pngs/revenue.png')); ?>');
                        $('#mobile_tab_text').text('<?php echo e(__('userpage.revenue')); ?>');
...
<?php echo $__env->make('layouts.mobile_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user_mobile/user-revenue-view.blade.php ENDPATH**/ ?>