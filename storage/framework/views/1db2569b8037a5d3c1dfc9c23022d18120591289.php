    ...
    <div id="settings-card-pc">
        <div class="settings-card-header justify-content-center notice-card-header mt-3" style="display: flex;">
            <ul class="nav nav-underline mt-3" style="font-size: 16px">
                <li class="nav-item">
                    <a class="nav-link active" id="link-settings-api" data-set="api" href="#"><?php echo e(__('userpage.api')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="link-settings-trade" data-set="trade" href="#"><?php echo e(__('userpage.trade')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="link-settings-coin" data-set="coin" href="#"><?php echo e(__('userpage.coin')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="link-settings-normal" data-set="normal" href="#"><?php echo e(__('userpage.normal')); ?></a>
                </li>
            </ul>
            <div class="d-flex align-items-center mt-3 pl-3 pt-1 pb-1 pr-3 position-absolute" style="right:2rem; width: auto; height: 1.5rem; border-radius: 1rem; background-color: #F0F1F4;">
                <span class="d-flex mr-3" style="font-size: 0.75rem"><?php echo e(__('userpage.fee_rate')); ?></span>
        ...
        <div class="container form-group settings-card-body d-flex justify-content-center">
            <div class="mt-3" id="setting_api" style="display:block; width: 100%">
                <?php echo $__env->make('user.user-setting-api-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div class="mt-3" id="setting_trade" style="display:none; width: 60%">
                <?php echo $__env->make('user.user-setting-trade-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div class="mt-3" id="setting_coin" style="display:none; width: 100%">
                <?php echo $__env->make('user.user-setting-coin-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>

            <div class="mt-3" id="setting_normal" style="display:none; width: 60%">
                <?php echo $__env->make('user.user-setting-normal-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.master_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/user/user-setting-view.blade.php ENDPATH**/ ?>