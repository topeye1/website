        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="d-flex justify-content-center align-items-center">
                    <div class="d-flex mr-3"><?php echo e(__('userpage.paying_point_count')); ?></div>
                    ...
                    <div id="btn-point-paying" class="btn btn-success m-1 pt-1 pb-1" style="background-color: #e3a90d; border-color: #c5920a; color: #fff;"><?php echo e(__('userpage.paying')); ?></div>
                </div>
                <div class="error-text text-center" id="error_input_points" style="display: none"><?php echo e(__('userpage.err_input_points')); ?></div>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\ddukddak\resources\views/modals/point-paying-modal.blade.php ENDPATH**/ ?>